...
#pragma warning disable
    ...
    {
        /// <summary>
        /// تبدیل تاریخ شمسی رشته به تاریخ میلادی
        /// </summary>
        /// <param name="pDate">رشته حاوی تاریخ شمسی</param>
        /// <param name="fallback">رشته تارخ میلادی برای جایگزینی در حالت خطا پیش فرض 0001/01/01</param>
        /// <returns>تاریخ میلادی معادل</returns>
        public static DateTime ConvertToDateTime(string pDate, string fallback = "0001-01-01")
        {
            var pdate = new PersianDateTime();
            bool success = PersianDateTime.TryParse(pDate, out pdate);
            return success ? pdate.ToDateTime() : DateTime.Parse(fallback);
        }
        ...
        /// <param name="pDate">رشته حاوی تاریخ شمسی</param>
        /// <param name="fallback">رشته تارخ میلادی برای جایگزینی در حالت خطا پیش فرض 0001/01/01</param>
        /// <returns>اگر ورودی null باشد خروجی هم null است در غیر این صورت تاریخ میلادی معادل</returns>
        public static DateTime? ConvertToNullableDateTime(string pDate, string fallback = "0001/01/01")
        {
            if (string.IsNullOrEmpty(pDate)) return null;
            return ConvertToDateTime(pDate, fallback);
        }
        ...
        public static PersianDateTime Parse(string persianDateTimeInString, string dateSeparatorPattern = @"\/|-")
        {
            ...
            persianDateTimeInString = PersianDigitsExtensionsHelper.ConvertDigitsToLatin(persianDateTimeInString);
        ...
        #endregion GetDifferentMonths Base On Seasons
