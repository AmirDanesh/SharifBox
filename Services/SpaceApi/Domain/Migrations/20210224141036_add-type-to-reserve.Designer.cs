...
namespace SpaceApi.Domain.Migrations
{
    ...
    [Migration("20210224141036_add-type-to-reserve")]
    partial class addtypetoreserve
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SpaceApi.Domain.Models.RentAbleChair", b =>
                {
                    b.HasOne("SpaceApi.Domain.Models.Space", "Space")
                        .WithOne("RentAbleChair")
                        .HasForeignKey("SpaceApi.Domain.Models.RentAbleChair", "SpaceId")
            ...
            modelBuilder.Entity("SpaceApi.Domain.Models.RentAbleConferenceRoom", b =>
                {
                    b.HasOne("SpaceApi.Domain.Models.Space", "Space")
                        .WithOne("RentAbleConferenceRoom")
                        .HasForeignKey("SpaceApi.Domain.Models.RentAbleConferenceRoom", "SpaceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SpaceApi.Domain.Models.RentAbleRoom", b =>
                {
                    b.HasOne("SpaceApi.Domain.Models.Space", "Space")
                        .WithOne("RentAbleRoom")
                        .HasForeignKey("SpaceApi.Domain.Models.RentAbleRoom", "SpaceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SpaceApi.Domain.Models.Space", b =>
                {
                    b.Navigation("RentAbleChair");

                    b.Navigation("RentAbleConferenceRoom");

                    b.Navigation("RentAbleRoom");
                });
